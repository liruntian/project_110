...
<!--          </div>-->
        ...
        <el-col :span="11">
          <div class="function-btns">
            ...
            <el-button @click="clearForm('summaryForm')" type="danger" >重填</el-button>
<!--            <el-button @click="newFont()" type="primary">暂存</el-button>-->
      ...
      <el-row :gutter="40" style="margin: 0">
        <el-form :model="declareForm" ref="summaryForm" status-icon label-width="30px" class="province-handin-form" style="padding-right: 30px; width: 75%" enctype='multipart/form-data'>
          <div class="helpinfo">
            <span>请省部级单位认真填写展会活动登记表，所有选项均为必填，没有请填无，提交后无法修改!所需上传的文件均为.pdf格式，且大小在10MB以内!</span>
          </div>
          <el-col :span="11">
...
<!--            </el-form-item>-->
          ...
          <el-col :span="11">
            <el-form-item prop="companyNum" style="margin-top: 20px">
