      ...
      <el-row>
        ...
        <el-col :span="11">
          <div class="function-btns">
            ...
            <el-button @click="clearForm('summaryForm')" type="danger" style="margin: 0 20px 0 30px">重填</el-button>
<!--            <el-button @click="newFont()" type="primary">暂存</el-button>-->
      ...
      <el-row :gutter="40" style="margin: 0">
        <el-form :model="declareForm" ref="summaryForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px; width: 75%" enctype='multipart/form-data'>
          <el-col :span="11">
